...
//
// Purpose:
// A smaller malloc as compared to standard newlib malloc
//
// $Id: xil_malloc.c,v 1.3.18.6 2005/11/15 23:41:01 salindac Exp $
//
////////////////////////////////////////////////////////////////
...
// const int M_DBG_NORMAL   = 0;
#define M_DBG_PARTIAL 1
// const int M_DBG_PARTIAL  = 1;
#define M_DBG_FULL 2
// const int M_DBG_FULL     = 2;
...
/////////////////////////////////////////////////////////////////////////////
// Flag values which let me know about the state of a memory block.
/////////////////////////////////////////////////////////////////////////////
#define M_ALLOCEDFLAG 0x5a
// const unsigned M_ALLOCEDFLAG = 0x5a;            // Indicator for allocated blk
#define M_ALLOCED 0xc99cc99c
// const unsigned M_ALLOCED     = 0xc99cc99c;      // End-of-block if debug level
#define M_FREEFLAG 0xa5
// const unsigned M_FREEFLAG    = 0xa5;            // Free block indicator.
#define M_FREE 0x9cc99cc9
// const unsigned M_FREE        = 0x9cc99cc9;      // End-of-block if debug level
#define M_ZEROFLAG 0xaa
// const unsigned M_ZEROFLAG    = 0xaa;            // Special flag assigned to
                                                // Zero length block.

/////////////////////////////////////////////////////////////////////////////
// Class which defines the header of a memory block.
/////////////////////////////////////////////////////////////////////////////
...
// const size_t M_BLOCKSIZE = 8; //  sizeof(struct M_HEADER)+sizeof(M_HEADERP); // Alignment
#define M_FREESIZE 512
// const int M_FREESIZE = 4096 / 8; // M_BLOCKSIZE ;      // Number of freelist entries.
#define M_BRKINC 2048
// const int M_BRKINC = 64 * 1024;                 // Size of incremental memory
                                                // hunks allocated;
/////////////////////////////////////////////////////////////////////////////
// Static variables.
/////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////
// Static variables for instrumentation purposes.
/////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////
// Debug aids.  Stop at certain allocations.
/////////////////////////////////////////////////////////////////////////////
int m_prtflag  = 0;
int m_stopaddr = 0;
int m_stopcnt  = 0;
...
M_HEADERP getmemblock(size_t n)
{
...
////////////////////////////////////////////////////////////////////////////
// Pointer debug routines.
////////////////////////////////////////////////////////////////////////////
BOOLEAN checkalloc(M_HEADERP this)
{
  if (!isalloced(this))
...
BOOLEAN checkfree(M_HEADERP this)
{
  DATA_T *d;
  int i;
  if (!isfree(this))
...
////////////////////////////////////////////////////////////////////////////
static
void addtofreelist (M_HEADERP h)
{
  long i;
...
void xil_malloc_debug (int level)
{
...
// Realloc
///////////////////////////////////////////////////////////////////////////
void* xil_realloc (void* oldblk, size_t newsize )
{
  M_HEADERP h;
  size_t oldsize;
  void* newblk;
...
// Calloc
///////////////////////////////////////////////////////////////////////////
void* xil_calloc (size_t number, size_t size)
{
  long*  longptr ;
  void*  blockptr ;
...
///////////////////////////////////////////////////////////////////////////
// Cool routine to report statistics.
///////////////////////////////////////////////////////////////////////////
#define M_STAT_NORMAL 0
// const int M_STAT_NORMAL = 0;
#define M_STAT_VERBOSE 1
// const int M_STAT_VERBOSE = 1;
#define M_STAT_REALLYVERBOSE 2
// const int M_STAT_REALLYVERBOSE = 2;

#ifdef DEBUG
void xil_mstats(int verbosity)
{  
